    ...
    public static class MessagingConfig
    {
        public static void ConfigureMessaging(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            var config = new GcpMessagingConfig()
                ...
                .ConfigureMessageType<AddBannerMessage>(messagingOptions.Value.Topics.AddBannerTopicName)
                .ConfigureMessageType<RemoveBannerMessage>(messagingOptions.Value.Topics.DeleteBannerTopicName);
